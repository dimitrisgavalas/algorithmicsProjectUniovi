...
public class BranchAndBound {
	//Logger: It is used to log the messages. Helps dev trace errors
	//log=entities
	//LoggerFactory is a utility class producing Loggers for various logging APIs
	//getLogger() method of a Logger class used find or create a logger
	...
	public void branchAndBound(Node rootNode) { 
		...
		//oso uparxoun nodes kai prunes einai panw apo to limit epanalve
